  ...
  <div class="row">
    ...
    <div class="col-md-2 col-sm-3">
      <ul class="nav nav-pills nav-stacked">
        <li><a id="themsukienclick">Thêm sự kiện</a></li>
        <li><a id="dssukienclick">Danh sách sự kiện</a></li>
        <li><a id="timtaikhoanclick">Tìm tài khoản</a></li>
        <li><a id="timsulienclick">Tìm sự kiện</a></li>
        <li><a id="quanlytkclick">Quản lý tài khoản</a></li>
      </ul>
    </div><!--Hết thanh menu-->
