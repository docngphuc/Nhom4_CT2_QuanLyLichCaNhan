...
function validateTextPass(id,id1)
{
	if($("#"+id).val() != $("#"+id1).val()){
	...
	$(document).ready(function(){
		$("#dangnhap").click(function(){
			...
			if(!validateText("login-passwword"))
				return false;
			if($("#login-username").val() == "admin" && $("#login-passwword").val() == "admin")
				window.location="admin/khoa-tim-tk-admin.jsp";
			if($("#login-username").val() == "user" && $("#login-passwword").val() == "user")
		...
		$("#dangky").click(function(){
			...
			if(!validateText("dangky-Confirmpassword"))
				...
				if(!validateTextPass("dangky-passwword","dangky-Confirmpassword"))
					return false;
			}
			});
			$("#goiyeucau").click(function(){
				$("#xacnhan-inputemail").keyup(function(){
					validateText("xacnhan-inputemail")
					validateemail("xacnhan-inputemail")
				});
				if (!validateText("xacnhan-inputemail")) {
					return false;
				}
				else
					if (!validateemail("xacnhan-inputemail")) {
						return false;
					}
			});
			...
			$("#dangky-Confirmpassword").keyup(function(){
				validateText("dangky-Confirmpassword");
				validateTextPass("dangky-passwword","dangky-Confirmpassword");
			});
	});
